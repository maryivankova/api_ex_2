...
class AuthUser(models.Model):
    """Model of User on this platform
    """
    ...
    """Always return True. It's method to know, whether user is authenticated or not."""
...
class Follower(models.Model):
    ...
    def __str__(self):
        return f'{self.subscriber} follower fo {self.user}'


class SocialLink(models.Model):
    """Model of social links of user
    """
